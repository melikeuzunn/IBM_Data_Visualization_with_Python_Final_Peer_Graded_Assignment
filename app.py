...
app.layout = html.Div(children=[
    ...
    html.H1('US Domestic Airline', style={'textAllign': 'center', 'color': '#503D36', 'front-size': 24}),
...
# Enter your code below. Make sure you have correct formatting.
@app.callback([Output(component_id='plot1', componenet_property='children'),
               Output(component_id='plot2', componenet_property='children'),
               Output(component_id='plot3', component_property='children'),
               Output(component_id='plot4', componenet_property='children'),
